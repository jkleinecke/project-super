...
// TODO(james): We probably want to unroll the loops and make these
...
inline f32_4x
AndNot(f32_4x A, f32_4x B) // NOTE: _B_ gets notted
{
    f32_4x Result;
...
Select(f32_4x A, f32_4x Mask, f32_4x B)
{
    ...
    // TODO(james): Use blend now that we are SSE 4.
...
// TODO(james): Some places where we Shuffle4x probably should be using
