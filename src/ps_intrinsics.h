...
//
// TODO(james): Convert all of these to platform-efficient versions
// and remove math.h
//
// cosf
// sinf
...
SignOf(f32 Value)
{
    // TODO(james): Look at octahedral code and figure out
...
#else
    // TODO(james): Actually port this to other compiler platforms!
    Amount &= 31;
...
{
    // TODO(james): Do we want to forgo the use of SSE 4.1?
