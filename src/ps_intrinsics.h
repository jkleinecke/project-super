//
// TODO(james): Figure out if we even need these???
...
SignOf(f32 Value)
{
    // TODO: Look at octahedral code and figure out
...
{
    // TODO: Do we want to forgo the use of SSE 4.1?
